package de.tu_dresden.inf.st.uvl.bp.metamodel.parsing;
...
public class ParsingTests {
    ...
    // root directory
    private static final String TEST_MODEL_PREFIX = "src" + File.separator + "test" + File.separator + "resources" + File.separator;
    ...
    private static final String BP_MODEL_PREFIX = TEST_MODEL_PREFIX + "bp" + File.separator;
    
    // sub sub directories
    private static final String NESTED_MODEL_PREFIX = COMPOSITION_MODEL_PREFIX + "nested" + File.separator;
    private static final String FEATURE_CARDINALITY_MODEL_PREFIX = ARITHMETIC_MODEL_PREFIX + "feature_cardinality" + File.separator;
    ...
    private static final String FEATURE_CARDINALITY = FEATURE_CARDINALITY_MODEL_PREFIX + "feature-cardinality.uvl";
    ...
    private static final String SMART_HOME = BP_MODEL_PREFIX + "smart_home.uvl";
    private static final String DRONE = BP_MODEL_PREFIX + "drone_0.uvl";
