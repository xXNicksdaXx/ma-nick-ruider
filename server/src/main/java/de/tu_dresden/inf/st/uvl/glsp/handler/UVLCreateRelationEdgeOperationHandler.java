...
public class UVLCreateRelationEdgeOperationHandler extends GModelCreateOperationHandler<CreateEdgeOperation> {
    ...
    protected void removeExistingEdge(Feature source, Feature target, GEdge gEdge) {
        ...
        Group existingGroup = source.getChildren().stream()
